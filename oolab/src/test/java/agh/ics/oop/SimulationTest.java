...
////        WorldMap map = new RectangularMap(3,4);
////        // given
////        String[] characters = {"f", "b",
////                "r", "l",
////                "f", "f",
...
////
////    // test for GrassField
////    private GrassField prepareGrassField(List<Vector2d> mockPositionsGrass){
...
////
////    @Test
////    void infinityMapCheck(){
////        // given
////        GrassField grassField = prepareGrassField(Arrays.asList(
////                new Vector2d(0, 0),
////                new Vector2d(1, 1),
////                new Vector2d(2, 2),
////                new Vector2d(3, 5),
...
////        // then
////        List<Animal> animalsList = simulation.getAnimals();
////        assertTrue(animalsList.getFirst().isAt(new Vector2d(-2,-5)));
////        assertTrue(animalsList.getFirst().atDirection(MapDirection.WEST));
////    }
////
////    @Test
////    void noCollisionWithGrass(){
////        // given
////        GrassField grassField = prepareGrassField(Arrays.asList(
////                new Vector2d(1, 2),
////                new Vector2d(1, 3),
...
////        // then
////        List<Animal> animalsList = simulation.getAnimals();
////        assertTrue(animalsList.getFirst().isAt(new Vector2d(3,2)));
////        assertTrue(animalsList.getFirst().atDirection(MapDirection.SOUTH));
////    }
////
////    @Test
////    void withTwoAnimalsThatHaveCollision(){
////        // given
////        GrassField grassField = prepareGrassField(Arrays.asList(
////                new Vector2d(1, 2),
////                new Vector2d(1, 3),
...
////        assertTrue(animalsList.getFirst().atDirection(MapDirection.SOUTH));
////
////        assertTrue(animalsList.getLast().isAt(new Vector2d(3,7)));
////        assertTrue(animalsList.getLast().atDirection(MapDirection.NORTH));
////    }
////    @Test
////    void onFourAnimalsGrass(){
////        // given
////        GrassField grassField = prepareGrassField(Arrays.asList(
////                new Vector2d(0, 0),
////                new Vector2d(1, 1),
